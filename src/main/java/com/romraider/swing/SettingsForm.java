...
public class SettingsForm extends AbstractFrame implements MouseListener, ActionListener {
    ...
    public SettingsForm() {
        ...
        btnChooseFont.addActionListener(this);
        reset.addActionListener(this);

    }

    /** Opens the unified settings window directly on modern display options. */
    public void selectAppearanceTab() {
        int index = settingsTabbedPane.indexOfTab("Appearance");
        if (index >= 0) settingsTabbedPane.setSelectedIndex(index);
    }

    private void modernizeShell() {
        JMenuBar titleBar = new JMenuBar();
        titleBar.setName("SETTINGS WINDOW TITLE BAR");
        setJMenuBar(titleBar);
        settingsTabbedPane.setTabLayoutPolicy(
                javax.swing.JTabbedPane.WRAP_TAB_LAYOUT);
        settingsTabbedPane.setName("SETTINGS TABS");
        settingsTabbedPane.setPreferredSize(new Dimension(
                UiScaleService.getInstance().control(720),
                UiScaleService.getInstance().control(430)));

        JPanel heading = new JPanel(new BorderLayout(0, 3));
        heading.setOpaque(false);
        JLabel title = new JLabel("RomRaider2 Settings");
        title.setFont(title.getFont().deriveFont(Font.BOLD,
                title.getFont().getSize2D() + 3.0f));
        JLabel description = new JLabel(
                "Editor behavior, calibration display, and application appearance");
        ...
        footer.add(reset, BorderLayout.WEST);
        ...
        content.add(settingsTabbedPane, BorderLayout.CENTER);
        content.add(footer, BorderLayout.SOUTH);
        setContentPane(content);
        getRootPane().setDefaultButton(btnOk);
        setMinimumSize(new Dimension(
                UiScaleService.getInstance().control(680),
                UiScaleService.getInstance().control(520)));
        setResizable(true);

        configureColorTarget(maxColor, "Maximum value color");
        configureColorTarget(minColor, "Minimum value color");
        configureColorTarget(highlightColor, "Highlighted cell color");
        configureColorTarget(selectColor, "Selected cell color");
        configureColorTarget(axisColor, "Axis cell color");
        configureColorTarget(warningColor, "Warning color");
        configureColorTarget(increaseColor, "Increased value border color");
        configureColorTarget(decreaseColor, "Decreased value border color");
        configureColorTarget(liveValueColor, "Stale live value color");
        configureColorTarget(curLiveValueColor, "Current live value color");
        pack();
    }

    private static void configureColorTarget(JLabel target, String name) {
        target.setName(name.toUpperCase());
        target.setToolTipText("Choose " + name.toLowerCase());
        target.setPreferredSize(new Dimension(64, 26));
        target.setMinimumSize(new Dimension(48, 26));
        target.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        target.getAccessibleContext().setAccessibleName(name);
    }
    ...
    private JPanel appearancePanel() {
        ...
        panel.setBorder(javax.swing.BorderFactory.createEmptyBorder(
                16, 16, 16, 16));
        JPanel introduction = new JPanel(new BorderLayout(0, 4));
        introduction.setOpaque(false);
        JLabel title = new JLabel("Application appearance");
        title.setFont(title.getFont().deriveFont(Font.BOLD,
                title.getFont().getSize2D() + 1.0f));
        JLabel help = new JLabel(
                "<html>Adjust scale, interaction mode, and theme. "
                + "Changes are previewed immediately.</html>");
        help.setForeground(UIManager.getColor("Label.disabledForeground"));
        introduction.add(title, BorderLayout.NORTH);
        introduction.add(help, BorderLayout.CENTER);
        appearancePreferences = new DisplayPreferencesPanel();
        JPanel card = new JPanel(new BorderLayout());
        card.setBorder(javax.swing.BorderFactory.createCompoundBorder(
                javax.swing.BorderFactory.createTitledBorder("Display"),
                javax.swing.BorderFactory.createEmptyBorder(10, 10, 10, 10)));
        card.add(appearancePreferences, BorderLayout.NORTH);
        panel.add(introduction, BorderLayout.NORTH);
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(Alignment.TRAILING)
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel2Layout.createParallelGroup(Alignment.TRAILING)
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                .addComponent(maxColor, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE)
                                                                .addPreferredGap(ComponentPlacement.RELATED, 139, Short.MAX_VALUE)
                                                                .addComponent(lblHighlight)
                                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                                .addComponent(highlightColor, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE))
                                                                .addGroup(jPanel2Layout.createSequentialGroup()
                                                                        .addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
                                                                                .addGroup(Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                                                                        .addComponent(minColor, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE)
                                                                                        .addPreferredGap(ComponentPlacement.RELATED, 172, Short.MAX_VALUE)
                                                                                        .addComponent(lblAxis))
                                                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                                                .addComponent(warningColor, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE)
                                                                                                .addPreferredGap(ComponentPlacement.RELATED, 151, Short.MAX_VALUE)
                                                                                                .addComponent(lblSelect)))
                                                                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                                                                .addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
                                                                                                        .addComponent(selectColor, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                                                                        .addComponent(axisColor, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE))))
                                                                                                        .addContainerGap())
                );
        jPanel2Layout.setVerticalGroup(
                ...
                .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE)
                                .addComponent(lblMax)
                                .addComponent(maxColor, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)
                                .addComponent(highlightColor, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)
                                .addComponent(lblHighlight))
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE)
                                        .addComponent(lblMin)
                                        .addComponent(minColor, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(axisColor, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(lblAxis))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
                                                .addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE)
                                                        .addComponent(warningColor, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(lblWarning))
                                                        .addComponent(selectColor, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(lblSelect))
                                                        .addContainerGap())
                );
        ...
        jPanel3Layout.setHorizontalGroup(
            jPanel3Layout.createParallelGroup(Alignment.TRAILING)
                .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addPreferredGap(ComponentPlacement.RELATED)
                    .addGroup(jPanel3Layout.createParallelGroup(Alignment.TRAILING)
                        .addComponent(increaseColor, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE)
                        .addComponent(liveValueColor, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(ComponentPlacement.RELATED, 110, Short.MAX_VALUE)
                    .addGroup(jPanel3Layout.createParallelGroup(Alignment.LEADING)
                        .addGroup(Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                            .addComponent(lblCurLiveValue)
                            .addPreferredGap(ComponentPlacement.RELATED)
                            .addComponent(curLiveValueColor, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE))
                        .addGroup(Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                            .addComponent(lblDecrease)
                            .addPreferredGap(ComponentPlacement.RELATED)
                            .addComponent(decreaseColor, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE)))
                    .addContainerGap())
        );
                ...
                .addGroup(jPanel3Layout.createSequentialGroup()
                    .addGroup(jPanel3Layout.createParallelGroup(Alignment.LEADING)
                        .addGroup(jPanel3Layout.createParallelGroup(Alignment.BASELINE)
                            .addComponent(decreaseColor, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblDecrease)
                            .addComponent(lblIncrease))
                        .addComponent(increaseColor, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel3Layout.createParallelGroup(Alignment.BASELINE)
                        .addComponent(lblLiveValue)
                        .addComponent(liveValueColor, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)
                        .addComponent(lblCurLiveValue)
                        .addComponent(curLiveValueColor, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)))
        );
        ...
        settingsTabbedPane.addTab("Appearance", appearancePanel());
    ...
    private void initTabs() {
        ...
        jPanelDefaultLayout.setVerticalGroup(
                ...
                .addGroup(jPanelDefaultLayout.createSequentialGroup()
                        ...
                        .addComponent(debug)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(panelUISettings, GroupLayout.PREFERRED_SIZE, 230, GroupLayout.PREFERRED_SIZE)
        ...
        gl_panelUISettings.setVerticalGroup(
                ...
                .addGroup(gl_panelUISettings.createSequentialGroup()
                        ...
                        .addComponent(panelTreeSettings, GroupLayout.PREFERRED_SIZE, 126, GroupLayout.PREFERRED_SIZE))
                );
        ...
        jPanelTableDisplayLayout.setVerticalGroup(
                ...
                .addGroup(jPanelTableDisplayLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelTableDisplayLayout.createParallelGroup(Alignment.BASELINE)
                                ...
                                .addGroup(jPanelTableDisplayLayout.createParallelGroup(Alignment.BASELINE)
                                        .addComponent(lblFont)
                                        .addComponent(btnChooseFont, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
                                        .addContainerGap())
                );
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btnApply) {
            ...
            if (appearancePreferences != null) {
                appearancePreferences.refreshFromSettings();
            }
        }
    }
