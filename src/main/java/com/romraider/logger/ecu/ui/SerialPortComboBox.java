...
public final class SerialPortComboBox extends JComboBox implements SerialPortRefreshListener {
    ...
    private static final String J2534_INTERFACE = "J2534";

    public SerialPortComboBox() {
    }

    public synchronized void showJ2534Interface() {
        removeAllItems();
        addItem(J2534_INTERFACE);
        setEnabled(false);
        setToolTipText("J2534 communicates directly with the adapter; no COM port is required.");
    }
