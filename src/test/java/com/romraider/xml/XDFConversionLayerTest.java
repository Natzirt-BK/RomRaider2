...
public class XDFConversionLayerTest{
    ...
    public void loadXDFs() {
        File folder = new File(System.getProperty("romraider.xdf.corpus",
                "C:\\Users\\User\\Downloads\\BMW-XDFs-master\\"));
        assumeTrue("Optional BMW XDF corpus is not configured",
                folder.isDirectory());
