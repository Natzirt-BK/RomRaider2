...
application_image=${ROMRAIDER2_APP_IMAGE:-$repo_root/build/release-1.1.11/RomRaider2}
output_root=${1:-$repo_root/build/releases}
release_name=${ROMRAIDER2_RELEASE_NAME:-RomRaider2_ECU_Studio_1.1.11_Linux_x64}
