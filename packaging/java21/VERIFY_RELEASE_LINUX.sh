...
[[ -f lib/app/romraider2-javafx-desktop-1.1.10.jar ]]
...
[[ -f VERSION.txt ]]
[[ -f docs/RELEASE_READINESS.md ]]
[[ -f docs/RELEASE_QUALIFICATION_RECORD.md ]]
...
grep -Fxq 'RomRaider2 ECU Studio 1.1.10' VERSION.txt
