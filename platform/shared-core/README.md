...
macOS work. It currently provides bounded ROM byte editing, exact RomRaider ECU
definition matching, scaled numeric table editing, and a bounded logger
...
It does not correct calibration checksums, own a platform USB device, flash, or
write ECU memory. Desktop services will be moved behind this boundary only when
their behavior can stay identical and their existing tests continue to pass.
